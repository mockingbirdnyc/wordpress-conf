...
class wplook_staff_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'wplook_staff_widget',
			__( 'WPlook Staff (Home Page)', 'conference-wpl' ),
			array( 'description' => __( 'A widget for displaying staff', 'conference-wpl' ), )
		);
	}
	...
	public function form( $instance ) {
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('nr_posts'); ?>"> <?php _e('Number of Staff:', 'conference-wpl'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('Number of Staff you want to display', 'conference-wpl'); ?></p>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id('read_more_link'); ?>"> <?php _e('URL to all Staff:', 'conference-wpl'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('View all staff URL', 'conference-wpl'); ?></p>
			</p>

			<br />
			<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('The ID of this widget is: <strong>staff</strong>', 'conference-wpl'); ?></p>
			<br />
								...
								<h2><?php echo $title; ?></h2>
									...
									<?php if ($read_more_link) { ?>
										...
										<div class="view-all-speakers">
											<a href="<?php echo $read_more_link; ?>" class="btn-default"><?php _e('View all Staff', 'conference-wpl'); ?></a>
										</div>
									<?php } ?>
							</div>
						</div>
